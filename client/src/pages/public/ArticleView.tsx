...
const ArticleView: FC = () => {
  ...
  return (
    <main>
      <div className='h-11 sticky bg-white top-0 border-b'></div>
      {
        
        <article className='sm:max-w-3xl mx-auto grid gap-y-3 mt-4 p-6'>
          <h1 className='sourceSerif text-5xl font-semibold'> {article?.title} </h1>
          ...
          <div className='!sourceSerif text-lg'> {parser(article?.content || "")}  </div>
        </article>
      }
    </main>
  )
